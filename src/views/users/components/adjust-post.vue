    ...
    <div>
      ...
      >
        <el-form-item
          ...
          prop="types"
        >
          <span v-if="item.oldValue != ''"><el-input
              v-model="item.oldValue"
              style="width: 220px;"
            /><span class="Label">-></span><el-input
              v-model="item.newValue"
              style="width: 220px;"
            /></span>
          <span v-if="item.title == '调岗时间'"><el-input
              v-model="item.newValue"
              style="width: 220px;"
            /></span>
          <span v-if="item.title == '调岗原因'"><el-input
              v-model="item.newValue"
              style="width: 220px;"
            /></span>
          <span v-if="item.type == 'img'"><img
