    ...
    <div class="contLeft">
      <div class="topTit">
        ...
        <div class="info">
          ...
          <p class="time">入职时间: {{ user.timeOfEntry | formatDate }} 最新工资： {{ formLabelAlign.currentPostWage + formLabelAlign.currentBasicSalary }}
      ...
      <div>
        ...
        <div class="fund">
          <div class="title"> <strong>社保公积金</strong> <span>企业 {{ socialData.socialSecurityEnterprise + socialData.providentFundEnterprises }}</span>
        ...
        <div class="formTable">
          ...
          >
            ...
            >
              <el-input
                v-model="atteData.actualAtteOfficialDays"
                placeholder="0"
                :disabled="true"
              />
            </el-form-item>
